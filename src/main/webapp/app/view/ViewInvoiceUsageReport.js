Ext.define(App.path('view.ViewInvoiceUsageReport'), {
	extend : 'Ext.form.Panel',
	itemId : 'ViewInvoiceUsageReport',
	bodyStyle : 'background-color: transparent',
	border : false,
	autoScroll : true,
	title : 'Báo cáo tình hình sử dụng hóa đơn',
	layout : {
		type : 'hbox',
		pack : 'start',
		align : 'stretch'
	...
	GetReport : function () {
		...
		if(me.IsValidForm()){
			...
			var fixed = this.down('#fixed').getValue();
			...
			Ext.MessageBox.show({
				...
				App.Action.InvoiceUsageReport(App.Session.userName, invoice_agency_id, in_month, fixed, function(options, success, response) {
							if (success) {
								...
								if (response.success) {
								    ...
								    iframe.src = "files/"+response.file_path;
								} else {
